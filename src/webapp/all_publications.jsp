    ...
    <body>
        ...
        <c:if test="${vers.rowCount>0}">    
            <display:table class="datatable" id="record" name="${vers.rows}">
                <display:column title="DESC ID" style="text-align:left;" group="1">
                ...
                <display:column title="State" property="state" style="text-align:left;" group="3"></display:column> 
                <display:column title="Status" property="status" style="text-align:left;"></display:column> 
                <display:column title="Doc type" property="pubtype" style="text-align:left;"></display:column> 
