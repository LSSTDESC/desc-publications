...
public class ConnectionManager {
    ...
    public static Connection getConnection(HttpServletRequest request) throws ServletException {
        ...
        if (dataSourceName == null) {
            dataSourceName = session.getServletContext().getInitParameter("javax.servlet.jsp.jstl.sql.dataSource");
        }
        try {
    ...
    public static Connection getConnection(ServletContext context, String dataSourceName) throws NamingException, SQLException {
